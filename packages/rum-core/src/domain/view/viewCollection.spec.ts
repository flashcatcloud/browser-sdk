import { DISCARDED, HookNames, Observable } from '@flashcatcloud/browser-core'
import type { Duration, RelativeTime, ServerDuration, TimeStamp } from '@flashcatcloud/browser-core'
