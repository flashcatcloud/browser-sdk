import type { ClocksState, Context, Observable } from '@flashcatcloud/browser-core'
import { noop, combine, toServerDuration, generateUUID, SKIPPED, HookNames } from '@flashcatcloud/browser-core'
