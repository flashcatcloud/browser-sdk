import type { RelativeTime, TimeStamp, ErrorWithCause } from '@flashcatcloud/browser-core'
import { ErrorHandling, ErrorSource, NO_ERROR_STACK_PRESENT_MESSAGE } from '@flashcatcloud/browser-core'
import { FAKE_CSP_VIOLATION_EVENT } from '@flashcatcloud/browser-core/test'
