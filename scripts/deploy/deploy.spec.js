...
void describe('deploy', () => {
    ...
    assert.deepEqual(getS3Commands(), [
      {
        // Logs bundle
        command:
          'aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/logs/bundle/flashcat-logs.js s3://browser-agent-artifacts-prod/flashcat-logs-v6.js',
        env,
      },
      {
        // Profiler chunk
        command: `aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum/bundle/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-prod/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        ...
        command: `aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum/bundle/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-prod/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      // RUM bundle
      {
        command:
          'aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum/bundle/flashcat-rum.js s3://browser-agent-artifacts-prod/flashcat-rum-v6.js',
        env,
      },
      // RUM slim bundle
      {
  ...
  void it('should deploy datacenter packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      {
        command:
          'aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/logs/bundle/flashcat-logs.js s3://browser-agent-artifacts-prod/us1/v6/flashcat-logs.js',
        env,
      },
      // RUM Profiler Chunk
      {
        command: `aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum/bundle/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-prod/us1/v6/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        command: `aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum/bundle/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-prod/us1/v6/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        command:
          'aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum/bundle/flashcat-rum.js s3://browser-agent-artifacts-prod/us1/v6/flashcat-rum.js',
        env,
      },
      {
        command:
  ...
  void it('should deploy staging packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      {
        command:
          'aws s3 cp --cache-control max-age=900, s-maxage=60 packages/logs/bundle/flashcat-logs.js s3://browser-agent-artifacts-staging/flashcat-logs-staging.js',
        env,
      },
      // RUM Profiler Chunk
      {
        command: `aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum/bundle/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-staging/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        command: `aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum/bundle/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-staging/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        command:
          'aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum/bundle/flashcat-rum.js s3://browser-agent-artifacts-staging/flashcat-rum-staging.js',
        env,
      },
      {
        command:
  ...
  void it('should deploy PR packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      {
        command:
          'aws s3 cp --cache-control max-age=900, s-maxage=60 packages/logs/bundle/flashcat-logs.js s3://browser-agent-artifacts-staging/pull-request/123/flashcat-logs.js',
        env,
      },
      // RUM Profiler Chunk
      {
        command: `aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum/bundle/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-staging/pull-request/123/chunks/profiler-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        command: `aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum/bundle/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js s3://browser-agent-artifacts-staging/pull-request/123/chunks/recorder-${FAKE_CHUNK_HASH}-flashcat-rum.js`,
        env,
      },
      {
        command:
          'aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum/bundle/flashcat-rum.js s3://browser-agent-artifacts-staging/pull-request/123/flashcat-rum.js',
        env,
      },
      {
        command:
